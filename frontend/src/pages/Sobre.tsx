...
import { GraduationCap, Users, BookOpen, Target, Heart, LogIn, FileText, MapPin, Clock, Recycle, Building2 } from "lucide-react";
...
const Sobre = () => {
  ...
  const handleLogoClick = () => {
    // Se já estiver na página sobre, rola para o topo
    if (window.location.pathname === "/sobre") {
      window.scrollTo({ top: 0, behavior: "smooth" });
    } else {
      // Caso contrário, navega para a página sobre
      navigate("/sobre");
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <Card className="border-2 mb-16">
          <CardContent className="p-8">
            <div className="text-center">
              <WhatsAppIcon className="w-12 h-12 text-primary mx-auto mb-4" />
